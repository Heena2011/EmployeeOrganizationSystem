...
/*
	...
	public Employee(int id, String name, String department, String status, String phoneno, double salary,
			Date createddtm, String createdby, Date updateddtm, String updatedby, String emailid, Country country) {
		super();
		this.id = id;
		this.name = name;
